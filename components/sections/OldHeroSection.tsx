...
export default function HeroSection() {
  ...
  >
    ...
    {/* Smaller + controlled subtitle */}
    <span className="block text-accent relative mt-2 sm:mt-3 font-semibold tracking-wide"
      style={{ fontSize: "clamp(0.9rem, 2.5vw, 1.5rem)" }}
    >
      Frontend Developer
      {/* <span className="absolute -bottom-1 left-0 w-16 h-[2px] bg-accent rounded-full" /> */}
    </span>
  </h1>
</div>
